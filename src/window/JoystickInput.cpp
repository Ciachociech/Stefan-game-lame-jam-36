...
std::vector<PressedButton> JoystickInput::getInput() {
	...
	if (sf::Joystick::hasAxis(0, sf::Joystick::X)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::X) < -1.0) {
			input.push_back(PressedButton::leftX);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::X) > 1.0) {
			input.push_back(PressedButton::rightX);
		}
	}
	if (sf::Joystick::hasAxis(0, sf::Joystick::Y)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::Y) < -1.0) {
			input.push_back(PressedButton::upY);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::Y) > 1.0) {
			input.push_back(PressedButton::downY);
		}
	}
	if (sf::Joystick::hasAxis(0, sf::Joystick::Z)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::Z) < -1.0) {
			input.push_back(PressedButton::leftX);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::Z) > 1.0) {
			input.push_back(PressedButton::rightX);
		}
	}
	if (sf::Joystick::hasAxis(0, sf::Joystick::R)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::R) < -1.0) {
			input.push_back(PressedButton::upY);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::R) > 1.0) {
			input.push_back(PressedButton::downY);
		}
	}
	if (sf::Joystick::hasAxis(0, sf::Joystick::U)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::U) < -1.0) {
			input.push_back(PressedButton::leftU);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::U) > 1.0) {
			input.push_back(PressedButton::rightU);
		}
	}
	if (sf::Joystick::hasAxis(0, sf::Joystick::V)) {
		if (sf::Joystick::getAxisPosition(0, sf::Joystick::V) < -1.0) {
			input.push_back(PressedButton::upV);
		}
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::V) > 1.0) {
	...
	if (sf::Joystick::hasAxis(0, sf::Joystick::PovX)) {
		...
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::PovX) > 1.0) {
	...
	if (sf::Joystick::hasAxis(0, sf::Joystick::PovY)) {
		...
		else if (sf::Joystick::getAxisPosition(0, sf::Joystick::PovY) > 1.0) {
